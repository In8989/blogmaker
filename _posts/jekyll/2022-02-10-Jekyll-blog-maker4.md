...
navigation: True
title: jekyll 기반의 GitHub Page 생성(4) - CSS
...
### 웹 폰트 설정 + Font Awesome 사용하기
**_layout/default.html** 파일의 head 안에 link 추가
~~~ html
<!--  web font  -->
...
~~~
**assets/css/screen.css** 파일에 'Nanum Gothic' 추가
~~~ css
.post-full-content {
    position: relative;
    margin: 0 auto;
...
### 블로그를 꾸미기 위한 css 파일
앞서 생성한 파일들의 CSS style __assets/css/custom.css__ 를 생성
{% raw %}
~~~ css
